%% Generated by the Erlang ASN.1 BER-compiler version, utilizing bit-syntax:1.6.14.1
...
-asn1_info([{vsn,'1.6.14.1'},
            {module,'megaco_per_bin_media_gateway_control_prev3c'},
            {options,[per_bin,report_errors,{cwd,[47,110,101,116,47,105,115,105,108,100,117,114,47,108,100,105,115,107,47,100,97,105,108,121,95,98,117,105,108,100,47,111,116,112,95,112,114,101,98,117,105,108,100,95,114,49,52,98,46,50,48,49,48,45,48,57,45,49,51,95,49,57,47,111,116,112,95,115,114,99,95,82,49,52,66,47,108,105,98,47,109,101,103,97,99,111,47,115,114,99,47,98,105,110,97,114,121]},{outdir,[47,110,101,116,47,105,115,105,108,100,117,114,47,108,100,105,115,107,47,100,97,105,108,121,95,98,117,105,108,100,47,111,116,112,95,112,114,101,98,117,105,108,100,95,114,49,52,98,46,50,48,49,48,45,48,57,45,49,51,95,49,57,47,111,116,112,95,115,114,99,95,82,49,52,66,47,108,105,98,47,109,101,103,97,99,111,47,115,114,99,47,98,105,110,97,114,121]},noobj,{i,[46]},{i,[47,110,101,116,47,105,115,105,108,100,117,114,47,108,100,105,115,107,47,100,97,105,108,121,95,98,117,105,108,100,47,111,116,112,95,112,114,101,98,117,105,108,100,95,114,49,52,98,46,50,48,49,48,45,48,57,45,49,51,95,49,57,47,111,116,112,95,115,114,99,95,82,49,52,66,47,108,105,98,47,109,101,103,97,99,111,47,115,114,99,47,98,105,110,97,114,121]}]}]).
...
?RT_PER:encode_bit_string([],Tmpval4,[{onTimeOut,0},{onInterruptByEvent,1},{onInterruptByNewSignalDescr,2},{otherReason,3},{onIteration,4}])
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval6 of {_,Enumval8}-> Enumval8;_->Tmpval6 end) of
'internal' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 0)];
'external' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 1)];
'both' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,2}}], 2)];
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,4294967295}}],Tmpval7)))
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,65535}}],Tmpval8)))
end].
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_NotifyBehaviour'(Tmpval4)))
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_StatisticsDescriptor'(Tmpval4)))
end].
...
%% attribute number 3 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,4294967295}}],Tmpval2)))
end].
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_PropertyParm'(Tmpval1)))
end].
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval5 of {_,Enumval4}-> Enumval4;_->Tmpval5 end) of
'sendOnly' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 0)];
'recvOnly' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 1)];
'sendRecv' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 2)];
'inactive' -> [{bit,0},?RT_PER:encode_integer([{'ValueRange',{0,4}}], 3)];
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_IndAudStatisticsDescriptor'(Tmpval4)))
end].
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_TerminationIDList'(Tmpval1)))
end].
...
%% attribute number 5 with type ENUMERATED
?RT_PER:encode_open_type(dummy,?RT_PER:complete(case (case Tmpval2 of {_,Enumval3}-> Enumval3;_->Tmpval2 end) of
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_ContextAttrAuditRequest_contextPropAud'(Tmpval5)))
end,
...
%% attribute number 6 with type INTEGER
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_integer([{'ValueRange',{0,15}}],Tmpval6)))
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_boolean(Tmpval7)))
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_SelectLogic'(Tmpval9)))
end].
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_boolean(Tmpval4)))
end,
...
%% attribute number 5 with type SEQUENCE OF
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_ContextRequest_contextProp'(Tmpval5)))
end,
...
?RT_PER:encode_open_type(dummy,?RT_PER:complete('enc_ContextRequest_contextList'(Tmpval6)))
end].
...
%% attribute number 5 with type NULL
?RT_PER:encode_open_type(dummy,?RT_PER:complete(?RT_PER:encode_null(Tmpval3)))
end].
