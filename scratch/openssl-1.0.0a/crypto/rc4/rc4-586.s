...
L006PIC_me_up:
	popl	%edx
	movl	L_OPENSSL_ia32cap_P$non_lazy_ptr-L006PIC_me_up(%edx),%edx
	leal	8(%edi),%edi
	leal	(%esi,%ebp,1),%esi
	negl	%ebp
	xorl	%eax,%eax
...
L014pic_point:
	popl	%eax
	leal	L015opts-L014pic_point(%eax),%eax
	call	L016PIC_me_up
L016PIC_me_up:
	popl	%edx
	movl	L_OPENSSL_ia32cap_P$non_lazy_ptr-L016PIC_me_up(%edx),%edx
	btl	$20,(%edx)
	jnc	L017skip
	addl	$12,%eax
L017skip:
