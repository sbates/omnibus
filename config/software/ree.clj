...
(software "ree" :source "ruby-enterprise-1.8.7-2011.01"
          :steps [["env CFLAGS='-R/opt/opscode/embedded/lib -L/opt/opscode/embedded/lib -I/opt/opscode/embedded/include' ./installer -a /opt/opscode/embedded --dont-install-useful-gems --no-dev-docs"]])
